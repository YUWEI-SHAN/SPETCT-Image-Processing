...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actOpen_IODevice->setObjectName("actOpen_IODevice");
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/images/804.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actOpen_IODevice->setIcon(icon);
        actOpen_TextStream = new QAction(MainWindow);
        actOpen_TextStream->setObjectName("actOpen_TextStream");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/images/122.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actOpen_TextStream->setIcon(icon1);
        actQuit = new QAction(MainWindow);
        actQuit->setObjectName("actQuit");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/images/132.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actQuit->setIcon(icon2);
        actSave_IODevice = new QAction(MainWindow);
        actSave_IODevice->setObjectName("actSave_IODevice");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/images/104.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actSave_IODevice->setIcon(icon3);
        actSave_TextStream = new QAction(MainWindow);
        actSave_TextStream->setObjectName("actSave_TextStream");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/images/floppy.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actSave_TextStream->setIcon(icon4);
        actSave_TextSafe = new QAction(MainWindow);
        actSave_TextSafe->setObjectName("actSave_TextSafe");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/images/066.GIF"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        textEditDevice->setObjectName("textEditDevice");
        QFont font1;
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/images/29.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        textEditStream->setObjectName("textEditStream");
        QPalette palette;
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/images/133.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
